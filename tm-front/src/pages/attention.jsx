...
function attention(){
    return (
      <>
        ...
        <Accordion defaultActiveKey="0" className='attentionac' flush>
          <Accordion.Item eventKey="0">
            <Accordion.Header>Q<span className='mq'></span>전시 관람을 위해 사전 예약을 해야하나요?</Accordion.Header>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>Q<span className='mq'></span>신청하면 누구나 교육을 들을 수 있나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>Q<span className='mq'></span>강의계획서를 볼 수 있나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="3">
            <Accordion.Header>Q<span className='mq'></span>교육 및 행사 선발 확인은 어디서 하나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
              교육 및 행사 선발 확인은 공지사항에서 확인하실 수 있습니다.
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="4">
            <Accordion.Header>Q<span className='mq'></span>전시실에서 사진 촬영이 가능한가요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header>Q<span className='mq'></span>유모차와 휠체어를 대여할 수 있나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="7">
            <Accordion.Header>Q<span className='mq'></span>세번째미술관에서 발견한 전시 관련 도서 및 도록은 어디서 구매하나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="9">
            <Accordion.Header>Q<span className='mq'></span>아트상품 구입은 어디서 할 수 있나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
          ...
          <Accordion.Item eventKey="10">
            <Accordion.Header>Q<span className='mq'></span>소장품의 수집은 어떻게 이루어지나요?</Accordion.Header>
            <Accordion.Body className='attentionbody'>
